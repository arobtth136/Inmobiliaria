 ...
 * @author Gerardo GC
 */
public class pnlConsultaPropiedad extends javax.swing.JFrame {

    /**
     * Creates new form pnlConsultaPropiedad
     */
    public pnlConsultaPropiedad() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pnlConsultaPropiedad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pnlConsultaPropiedad().setVisible(true);
            }
        });
    }
